        ...
        <div class="d-flex justify-content-between">
            <figure>
                ...
                <blockquote class="blockquote">
                    <p style="color: white;"> Berisi data User Account di database</p>
                </blockquote>
                <figcaption class="blockquote-footer" style="color: white;">
                    CRUD <cite title="Source Title" style="color: white;">Create Read Update Delete</cite>
                </figcaption>
                <a href="index.php?page=user_create" class="btn btn btn-light">Tambah</a>
            </figure>
        </div>
