...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="d-flex justify-content-between">
            <figure>
                <h1 style="color: white;">Data Calon Koordinator</h1>
                <blockquote class="blockquote">
                    <p style="color: white;"> Berisi data Identitas Calon Koordinator di database</p>
                </blockquote>
                <figcaption class="blockquote-footer" style="color: white;">
                    CRUD <cite title="Source Title">Create Read Update Delete</cite>
                </figcaption>
                <a href="index.php?page=identitas_create" class="btn btn btn-light">Tambah</a>
            </figure>
        </div>
